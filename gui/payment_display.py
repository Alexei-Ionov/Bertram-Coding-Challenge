...
def on_button_click_restart(event,list,day,root, restart):
    if event.num == 1:
        # root.after(2000, lambda:  clear_gui(root))  
        global FINISHED
        FINISHED = True
def on_button_click_make_decision(event, label, least_list, root,payment, list, day,restart):
    if event.num == 1:  # Check if left mouse button was clicked
        ...
        button = tk.Button(root, text="onto the next day...", font=("Times New Roman", 20))
        button.pack()
        button.bind("<Button-1>", lambda event, arg1=day, arg2=list,arg3=root,arg4=restart: on_button_click_restart(event, arg1, arg2,arg3,arg4))


        


def display_payment(root,payment, day, list, restart):
    ...
    least_label = tk.Label(title_frame, text=f"The coworkers who've paid the least so far are:\n {str_least_list}", font=("Times New Roman", 30), fg="brown")
    ...
    button.bind("<Button-1>", lambda event, arg1=person_label, arg2=least_list, arg3=root,arg4=payment,arg5=list,arg6=day,arg7=restart: on_button_click_make_decision(event, arg1, arg2, arg3,arg4,arg5,arg6,arg7))
